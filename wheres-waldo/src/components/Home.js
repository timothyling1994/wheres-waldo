	...
	return(
		...
		<div className="Home">
			...
			<div className="levels-container">
				...
				<Link to={"/game"} onClick={()=>{setLevel(2)}} className="link"><Card imgSrc={props.levelSettings[2].imgSrcCropped} pics = {props.levelSettings[2].findPeoplePics} level={"LEVEL 3"}/></Link>
			</div>
		</div>
